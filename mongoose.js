...
mongoose
  .connect(
    `mongodb+srv://hohoho:happy1998@express-cluster.9f7s8.mongodb.net/` // hohoho ni yonida passwordni berish kerak! mongo db ulash uchun lekin password happy1998 emas boshqa shunchaki buni boshqalar ko'rmasligi uchun berib quyilgan.
  )
  .then(() => {
